...
lm_ranking <- lm(deaths * 100000 ~ gun_law_strength_ranked, data = df_likert) 
lm_ranking |> summary()
# Model 100k deaths from state grade
lm_likert <- lm(deaths * 100000 ~ likert, data = df_likert) 
lm_likert |> summary()
