...
base_graph +
  ...
  geom_line(
    aes(y = underemployment / 100, color = "Rate of part-time workers unable to work full time")) +
  labs(y = NULL) +
  theme(panel.grid = element_blank(), legend.position = "bottom") +
  scale_color_manual(
    values = c("Rate of part-time workers unable to work full time" = "red"),
    name = ""
  ) 
...
base_graph +
  ...
  # Target inflation rate line
  geom_hline(aes(yintercept = .02, linetype = "Target inflation rate = 2%"), alpha = .5) +
